...
<body>
    ...
    <form class="post_form" enctype="multipart/form-data" method="post" action="write.php">
        <!-- <p>書籍名:<input type="text" name="name" size="20"></p>
        <p>書籍URL:<input type="text" name="url" size="20"></p> 
        <p>書籍コメント:<input type="text" name="comment" size="20"></p> 
        <div>
            <input type="hidden" name="MAX_FILE_SIZE" value="1048576">
            <p>商品写真:<input type="file" name="image" accept="image/*"></p>
        </div>
